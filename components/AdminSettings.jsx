...
export default function AdminSettings() {
  ...
  return <div className="admin-view">
    ...
    <div className="admin-settings-grid">
      ...
      <section className="admin-setting-card"><header><span className="summary-icon"><AdminIcon name="payment"/></span><div><h2>Payment options</h2><p>One familiar place for customers to pay.</p></div></header><PaymentMethods className="admin-payment-methods" size={20} /><p>Customers are directed to Bonnie&apos;s dot.cards profile after their order is confirmed. Payment is completed there, not on this website.</p><a className="admin-btn admin-btn-secondary" href={SITE.paymentUrl} target="_blank" rel="noopener noreferrer">Open payment options <AdminIcon name="external"/></a><p className="admin-footnote">Check that payment arrived before marking an order paid. Opening this link does not confirm payment.</p></section>

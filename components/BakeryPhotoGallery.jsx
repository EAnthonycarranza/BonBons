...
// Two of these are commissioned photos rather than Bonnie's own. The section
// heading must not claim otherwise, and the closing note carries the
// disclosure now that the per-photo badges are gone.
const photos = [
  { src: "/products/bonbons-variety-styled.webp", width: 1536, height: 1024, alt: "Styled image of pink sprinkle, Biscoff crumb, strawberry, chocolate candy, and cookies-and-cream cake pops in clear wrappers", caption: "A little of everything", note: "Hand-finished, one pop at a time" },
  ...
  { src: "/products/bonbons-colorful-pops-styled.webp", width: 1448, height: 1086, alt: "Styled image of an assortment of Bon Bon’s pink, purple, cream, and chocolate cake pops with colorful toppings", caption: "Every batch has personality", note: "Colors, crumbs, and all the little details" },
];
  ...
  return (
    <section className="sec bakery-gallery" id="from-the-kitchen" aria-labelledby="bakery-gallery-title">
      <div className="wrap">
        ...
        <p className="bakery-gallery-note">Photos show past batches and packaging, and include styled images based on Bon Bon’s own. Available flavors are listed in the menu; your four-pack contains four cake pops.</p>
      </div>
    </section>
  );
}

...
export const SITE = {
  ...
  paymentInstructions: "Once Bonnie confirms your order and final total, open Bon Bon’s payment options on dot.cards and choose Venmo, Cash App, or Zelle. Put your order number in the payment note so it matches up automatically. Forgot to? No problem — just reply to this email or text Bonnie to say which app you paid from, so she can find it.",
  paymentCashInstructions: "You’ve chosen to pay cash at pickup. Nothing to send now — just bring the confirmed total with you. Changed your mind? Use the button below to pay ahead instead.",

...
import { DEFAULT_FOUR_PACK_PRICE, DEFAULT_SINGLE_POP_PRICE, SHOP_SETTINGS_TAG } from "./weekly-box";
...
export async function getShopSettings() {
  ...
  try {
    const supabase = createPublicSupabaseClient({ next: { revalidate: 60, tags: [SHOP_SETTINGS_TAG] } });
